...
func (sc *SearchClient) AdvancedSearch(queryText string, filters request.FilterRequest) ([]map[string]interface{}, error) {
	...
	combinedQuery.AddMustNot(mainQuery)
	combinedQuery.AddMustNot(filtersQuery)
