...
Технологии реализации: **Golang, Bleve, ReactJS, TailwindCSS, Docker, Prometheus**
...
Для установки полнотекстовой поисковой системы, следуйте следующим шагам:

1. Склонируйте репазитарий:

```bash
git clone https://github.com/aWatLove/searchengine.git
```
